export const en = {
  ...
  'dashboard.detailsTitle': 'Game details',
  'dashboard.detailPath': 'Install path',
  'dashboard.detailSupportPath': 'Support / saves path',
  'dashboard.detailStore': 'Store / launcher',
  'dashboard.detailModSupport': 'Mod support',
  'dashboard.detailMergeMods': 'Merge mods',
  'dashboard.detailYes': 'Yes',
  'dashboard.detailNo': 'No',
  'dashboard.detailCreated': 'Added to library',
  'dashboard.detailUpdated': 'Record updated',
  'dashboard.detailExtension': 'Extension',
  'dashboard.detailSteamAppId': 'Steam App ID',
  'dashboard.detailInstalledVersion': 'Installed version',
  'dashboard.detailDiskUsage': 'Space used',
  'dashboard.detailDiskUsageNoSymlinks': 'Space used (no symlinks)',
  'dashboard.detailSteamManifestSize': 'Size (Steam manifest)',
  'dashboard.detailsStatsLoading': 'Calculating\u2026',
  'dashboard.detailsStatsError': 'Could not load stats',
  ...
  'savesPage.colName': 'Name',
  'savesPage.colDate': 'Date',
  'savesPage.colSize': 'Size',
  'savesPage.colActions': 'Actions',
  'savesPage.colBackupName': 'Original save',
  'savesPage.openFolder': 'Open folder',
  'savesPage.openSaveFolder': 'Show in folder',
  'savesPage.delete': 'Delete',
  'savesPage.backup': 'Backup',
  'savesPage.restore': 'Restore',
  'savesPage.backups': 'Backups',
  'savesPage.showBackups': 'Show backups',
  'savesPage.backupsTitle': 'Save backups',
  'savesPage.noBackups': 'No backups yet. Use the shield icon on a save to create one.',
  'savesPage.deleteDialogTitle': 'Delete save file?',
  'savesPage.deleteDialogDesc': 'This will permanently delete the save file from disk.',
  'savesPage.restoreDialogTitle': 'Restore save backup?',
  'savesPage.restoreDialogDesc': 'This will copy the backup to the saves folder, overwriting any existing file with the same name.',
  'savesPage.protectionWarning': 'Warning: Changing mods may affect your save games. Consider backing up important saves first.',
