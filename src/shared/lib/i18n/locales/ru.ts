...
export const ru: Record<MessageKey, string> = {
  ...
  'savesPage.colName': 'Имя',
  'savesPage.colDate': 'Дата',
  'savesPage.colSize': 'Размер',
  'savesPage.colActions': 'Действия',
  'savesPage.colBackupName': 'Исходное сохранение',
  'savesPage.openFolder': 'Открыть папку',
  'savesPage.openSaveFolder': 'Показать в папке',
  'savesPage.delete': 'Удалить',
  'savesPage.backup': 'Копия',
  'savesPage.restore': 'Восстановить',
  'savesPage.backups': 'Копии',
  'savesPage.showBackups': 'Показать копии',
  'savesPage.backupsTitle': 'Резервные копии сохранений',
  'savesPage.noBackups': 'Копий пока нет. Используйте иконку щита для создания копии.',
  'savesPage.deleteDialogTitle': 'Удалить файл сохранения?',
  'savesPage.deleteDialogDesc': 'Файл сохранения будет безвозвратно удалён с диска.',
  'savesPage.restoreDialogTitle': 'Восстановить копию сохранения?',
  'savesPage.restoreDialogDesc': 'Копия будет помещена в папку сохранений, заменив файл с таким же именем.',
  'savesPage.protectionWarning': 'Внимание: изменение модов может повлиять на сохранения. Рекомендуется сделать резервные копии.',
