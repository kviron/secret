...
pub const KNOWN_GAMES: &[GameDefinition] = &[
    GameDefinition {
        ...
        supported_mod_types: &["simple", "fomod", "bsat", "scriptExtender", "enb"],
        merge_mods: true,
    ...
    GameDefinition {
        ...
        mod_support: ModSupportLevel::Full,
        supported_mod_types: &["simple", "fomod", "bsat", "scriptExtender"],
        merge_mods: true,
        support_path_suffix: "Data",
    },
    GameDefinition {
    ...
    GameDefinition {
        ...
        mod_support: ModSupportLevel::Full,
        supported_mod_types: &["simple", "fomod", "bsat"],
        merge_mods: true,
        support_path_suffix: "Data",
    },
    GameDefinition {
    ...
    GameDefinition {
        ...
        mod_support: ModSupportLevel::Full,
        supported_mod_types: &["simple", "fomod", "bsat", "scriptExtender", "dazip"],
        merge_mods: true,
        support_path_suffix: "Data",
    },
    GameDefinition {
